...
public class ResourceMachineBlock extends FortsStructureBlock {
    ...
    private FortsTeam nearestOwner(FortsMatchManager m,BlockPos pos){for(FortsTeam t:new FortsTeam[]{FortsTeam.RED,FortsTeam.BLUE}){if(m.bank(t)!=null)return t;}return FortsTeam.SPECTATOR;}
}
